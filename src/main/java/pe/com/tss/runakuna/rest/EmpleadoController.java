...
public class EmpleadoController extends BaseController{
	...
	public @ResponseBody  ResponseEntity<List<MarcacionResultViewModel>>  busquedaMarcacionesEmpleado(@RequestBody MarcacionFilterViewModel busquedaMarcacionDto) {
	...
	@RequestMapping(value = "/busquedaDiretorioEmpleado", method = RequestMethod.POST)
	public @ResponseBody  ResponseEntity<List<EmpleadoDirectorioResultViewModel>>  busquedaDiretorioEmpleado(@RequestBody EmpleadoQuickFilterViewModel quickFilter) {

		List<EmpleadoDirectorioResultViewModel> empleadoResult;
		empleadoResult = empleadoService.busquedaDirectorioEmpleado(quickFilter);
		if(empleadoResult == null)
			empleadoResult = new ArrayList<>();
	...
	public @ResponseBody NotificacionViewModel registrarEmpleado(@RequestBody EmpleadoViewModel empleado) {
		...
		if(empleado.getIdEmpleado() == null){
			...
			marcacionEmpleadoService.crearMarcacionesDesdeFechaIngreso(empleado);
	...
	public @ResponseBody EmpleadoViewModel obtenerEmpleado(@RequestBody Long idEmpleado) {
	...
	public @ResponseBody EmpleadoCabeceraViewModel obtenerEmpleadoCabecera(@RequestBody Long idEmpleado) {
		EmpleadoCabeceraViewModel empleado = empleadoService.obtenerEmpleadoCabecera(idEmpleado);
		return empleado;
	}
    ...
    @RequestMapping(value = "/obtenerEmpleadoPorCodigo", method = RequestMethod.POST)
    public EmpleadoViewModel obtenerEmpleadoPorCodigo(@RequestBody EmpleadoViewModel empleadoVM) {
    	EmpleadoViewModel dto;
    	dto = empleadoService.obtenerEmpleadoPorCodigo(empleadoVM);
        return dto;
    }
