...
public class HorasExtraController extends BaseController{
	...
	HoraExtraService horaExtraService;
	   ...
	   @RequestMapping(value = "/verHorasExtras", method = RequestMethod.POST)
	    ...
	    @RequestMapping(value = "/eliminarHorasExtraDashboard", method = RequestMethod.POST)
	    public NotificacionViewModel eliminarHorasExtraEmpleado(@RequestBody HorasExtraViewModel horasExtraDto) {
	    	NotificacionViewModel notificacion=new NotificacionViewModel();
	        notificacion=  horaExtraService.delete(horasExtraDto.getIdHorasExtra());
	        return notificacion;
		...
		@RequestMapping(value = "/obtenerHorasSemanalPendiente", method = RequestMethod.POST)
		public @ResponseBody HorasExtraViewModel obtenerHorasSemanalPendiente(@RequestBody HorasExtraViewModel horaExtra) {
				HorasExtraViewModel result = horaExtraService.obtenerHorasSemanalPendiente(horaExtra);
				return result;
		}
