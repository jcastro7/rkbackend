...
public class LicenciaController extends BaseController{
	...
	public @ResponseBody ResponseEntity<List<LicenciaEmpleadoResultViewModel>> busquedaRapidaLicencias(@RequestBody LicenciaEmpleadoQuickFilterViewModel busquedaLicenciaEmpleadoDto){
		List<LicenciaEmpleadoResultViewModel> result;
