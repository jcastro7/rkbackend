...
public class TemplateExcelExporter {
    ...
    public static final String FORMAT_NUMERIC = "###,###,##0";
    public static final String FORMAT_NUMERIC_INTEGER = "###,###,##0";
    public static final String FORMAT_NUMERIC_DECIMAL = "###,###,##0.00";
    ...
    public static final int HIDDEN_STYLE = 3;
    public static final int RIGHT_STYLE = 4;
    public static final int LEFT_STYLE = 5;
    public static final int BOTTOM_STYLE = 6;
    public static final int UNDERLINE_STYLE = 7;
    public static final int TOP_RIGHT_STYLE = 8;
    public static final int CENTER_STYLE = 9;
    public static final int DOWN_RIGHT_STYLE = 10;
