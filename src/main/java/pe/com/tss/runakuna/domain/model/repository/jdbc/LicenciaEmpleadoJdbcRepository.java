...
import pe.com.tss.runakuna.view.model.LicenciaEmpleadoQuickFilterViewModel;
...
public class LicenciaEmpleadoJdbcRepository implements LicenciaEmpleadoRepository{
	...
	private String generarObtenerLicencias(LicenciaEmpleadoFilterViewModel busquedaLicenciaEmpleadoDto,
		...
		sql.append(" select distinct li.IdLicencia as idLicencia, li.Comentario as comentario, li.DiaEntero as diaEntero, li.HoraInicio as horaInicio, li.HoraFin as horaFin,tl.IdTipoLicencia as idTipoLicencia, tl.Nombre as nombreTipoLicencia, e.IdEmpleado as idEmpleado, ");
        ...
        sql.append(params.filterDateDesde_US(" AND li.FechaInicio " , busquedaLicenciaEmpleadoDto.getFechaInicio()));
        sql.append(params.filterDateHasta_US(" AND li.FechaFin ", busquedaLicenciaEmpleadoDto.getFechaFin()));
...
//        sql.append(params.filter(" AND HISTORIAL.IdEmpleado = :idEmpleado ", busquedaLicenciaEmpleadoDto.getIdEmpleado()));
        sql.append(params.filter(" AND li.IdAtendidoPor = :idJefeInmediato ", busquedaLicenciaEmpleadoDto.getIdJefeInmediato()));
	...
	private String generarBusquedaRapidaLicencias(LicenciaEmpleadoQuickFilterViewModel quickFilter,
        ...
        sql.append(" li.FechaInicio as fechaInicio, li.FechaFin as fechaFin, li.Dias as dias , ");
        
        
        sql.append(" CASE WHEN (li.Estado='P') THEN 'Pendiente' ");
        sql.append(" WHEN (li.Estado='E') THEN 'Enviado' ");
        sql.append(" WHEN (li.Estado='A') THEN 'Aprobado' ");
        sql.append(" WHEN (li.Estado='V') THEN 'Validado' ");
        sql.append(" ELSE 'Denegado' END as estado ");
        ...
        sql.append(params.filter(" AND li.IdAtendidoPor = :idEmpleado ", quickFilter.getIdEmpleado()));
	...
	public List<LicenciaViewModel> verLicencias(PeriodoEmpleadoViewModel periodoEmpleado) {
	 ...
	 private String generarVerLicencias(PeriodoEmpleadoViewModel periodoEmpleado, WhereParams params) {
	        ...
	        sql.append(" ORDER BY LICENCIA.FechaInicio DESC ");
