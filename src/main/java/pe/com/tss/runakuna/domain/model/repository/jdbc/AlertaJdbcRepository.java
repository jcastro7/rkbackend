...
public class AlertaJdbcRepository implements AlertaRepository {
    ...
    private String generarAlerta(String codigo, WhereParams params) {
        ...
        sql.append(" A.UmbralAdvertencia as umbralAdvertencia, ");
        sql.append(" A.ColorAdvertencia as colorAdvertencia, ");
        sql.append(" A.UmbralCritico as umbralCritico, ");
        sql.append(" A.ColorCritico as colorCritico ");
	...
	private String generarBusquedaAlerta(AlertaFilterViewModel dto, WhereParams params) {
        ...
        sql.append(" Order by A.Codigo ASC ");
	...
	private String generarBusquedaSubscriptoresAlertas(AlertaViewModel dto, WhereParams params) {
        ...
        sql.append(" EMP.ApellidoPaterno+' '+EMP.ApellidoMaterno +' '+EMP.Nombre AS nombreEmpleado, ");
