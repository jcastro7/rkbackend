...
public class MarcacionViewModel extends AuditingEntityViewModel{
	...
	private List<SolicitudCambioMarcacionViewModel> solicitudesCambioMarcacion;
	
	private List<RegistroMarcacionViewModel> registrosMarcaciones;
	...
	public List<SolicitudCambioMarcacionViewModel> getSolicitudesCambioMarcacion() {
		return solicitudesCambioMarcacion;
	}

	public void setSolicitudesCambioMarcacion(List<SolicitudCambioMarcacionViewModel> solicitudesCambioMarcacion) {
		this.solicitudesCambioMarcacion = solicitudesCambioMarcacion;
	}

	public List<RegistroMarcacionViewModel> getRegistrosMarcaciones() {
		return registrosMarcaciones;
	}

	public void setRegistrosMarcaciones(List<RegistroMarcacionViewModel> registrosMarcaciones) {
		this.registrosMarcaciones = registrosMarcaciones;
	}
