...
public interface TablaGeneralService {
	...
	List<TablaGeneralViewModel> buscarGrupoTablaGeneral(Long idEmpresa);
	...
	NotificacionViewModel create(TablaGeneralResultViewModel tablaGeneralDto);
	NotificacionViewModel delete(Long idTablaGeneral);
