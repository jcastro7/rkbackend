...
public interface PeriodoEmpleadoService {
	...
	List<PeriodoEmpleadoResultViewModel> busquedaPeriodoDisponibleVacaciones(Long idEmpleado);

	List<PeriodoEmpleadoResultViewModel> busquedaTipoLicencia(Long idPeriodoEmpleado);	
}
