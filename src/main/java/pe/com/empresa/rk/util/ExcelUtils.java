...
public class ExcelUtils {
    ...
    public static String getDataStringCellAlways(Cell cell) {
    ...
    public static String getDataStringCellLane(Cell cell) {
        String dataCell = null;
        if (cell == null) return null;
        if (cell.getCellType() == Cell.CELL_TYPE_BLANK) return null;
        if (cell.getCellType() == (Cell.CELL_TYPE_STRING )) {
            ...
            if (NumberUtil.isInteger(BigDecimal.valueOf(cell.getNumericCellValue()))) {
    ...
    public static String getDataStringCell(Cell cell, String formato, Integer size) {
        ...
        if (size != null && StringUtils.hasText(dataCell)) {
            if (dataCell != null && dataCell.length() > size) {
                throw new RuntimeException("Error el length");
            }
        }
        return dataCell;
    }
    ...
    private static BigDecimal getDataBigDecimalCellIntern(Cell cell, boolean validateInteger) {
        ...
        if (cell.getCellType() == (Cell.CELL_TYPE_STRING)) {
            ...
            BigDecimal bigDecimal = new BigDecimal(cell.getStringCellValue().trim());
            if (validateInteger && !NumberUtil.isInteger(bigDecimal)) {
    ...
    public static BigDecimal getBigDecimalCell(Cell cell) {
        ...
        if (cell.getCellType() == (Cell.CELL_TYPE_STRING)) {
            ...
            dataCell = BigDecimal.valueOf(cell.getNumericCellValue());
