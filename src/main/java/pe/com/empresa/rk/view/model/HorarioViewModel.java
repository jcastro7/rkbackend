...
public class HorarioViewModel extends AuditingEntityViewModel{
	...
	public String getHorasCubiertas() {
		return horasCubiertas;
	}
	public void setHorasCubiertas(String horasCubiertas) {
