...
import pe.com.empresa.rk.service.TablaGeneralService;
...
public class TablaGeneralController extends BaseController{
	...
	@RequestMapping(value = "/buscarGrupoTablaGeneral", method = RequestMethod.GET)
	public @ResponseBody List<TablaGeneralViewModel> buscarGrupoTablaGeneral() {

		resultList = tablaGeneralService.buscarGrupoTablaGeneral();
		return resultList;
	}
