...
public class LoginJdbcRepository implements LoginRepository{
	...
	private String encontrarCurrentUser(String cuentaUsuario, WhereParams params) {
        ...
        sql.append(" u.Nombre+' '+u.ApellidoPaterno+' '+u.ApellidoMaterno AS nombreCompleto, ");
        sql.append(" u.Email AS email, ");
        sql.append(" EMP.IdEmpresa AS idEmpresa");
        sql.append(" FROM Usuario u ");
        sql.append(" LEFT JOIN Empleado EMP ON EMP.IdEmpleado = u.IdEmpleado ");
//        sql.append(" LEFT JOIN HistorialLaboral HISTORIAL ON HISTORIAL.IdEmpleado = u.IdEmpleado ");
