package pe.com.empresa.rk.security.auth.ajax;
...
import pe.com.empresa.rk.service.LdapService;
import pe.com.empresa.rk.service.impl.DatabaseUserService;
...
public class AjaxAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!ldapActive && !encoder.matches(password, user.getPassword())) {
                throw new BadCredentialsException("Usuario o contrase\u00f1a no validos.");
        }
